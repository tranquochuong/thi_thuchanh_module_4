package com.example.thikthp_module4.controller;
...
import com.example.thikthp_module4.service.city.CityService;
import com.example.thikthp_module4.service.country.CountryService;
...
public class HomeController {
    ...
    public ModelAndView doCreate(@Valid @ModelAttribute("city") CityDTO cityDTO, BindingResult bindingResult) {
        ...
        newCity.setArea(Double.parseDouble(String.valueOf(cityDTO.getArea())));
    ...
    public ModelAndView doUpdate(@PathVariable Long id, @Valid @ModelAttribute("city") CityDTO cityDTO, BindingResult bindingResult) {
        ...
        updateCity.setArea(Double.parseDouble(String.valueOf(cityDTO.getArea())));
